...
void Parser::ParseInput() {
   ...
   myData.FillDatabase(myLog.GetSchemes(), myLog.GetFacts(), myLog.GetRules(), myLog.GetQueries());
   
//std::cout << myLog.toString(); STILL NEED??
}
...
std::vector<Predicate*> Parser::parsePreds() {
