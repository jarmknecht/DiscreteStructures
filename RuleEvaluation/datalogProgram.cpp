...
std::vector<Scheme*> DataLog::GetSchemes() const {
   return this->schemes;
}

std::vector<Fact*> DataLog::GetFacts() const {
   return this->facts;
}

std::vector<Rule*> DataLog::GetRules() const {
   return this->rules;
}

std::vector<Query*> DataLog::GetQueries() const {
   return this->queries;
}
