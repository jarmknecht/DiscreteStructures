...
/*Relation::Relation(Scheme scheme, std::set<std::vector<std::string>> facts) { //dont think i need this constructor now
   this->rName = scheme.myID;
   this->schema = scheme.IDs;
   this->rows = facts;
}*/
